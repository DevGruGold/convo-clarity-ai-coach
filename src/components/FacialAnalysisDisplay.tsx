...
const FacialAnalysisDisplay: React.FC<FacialAnalysisDisplayProps> = ({ 
  ...
  const getEmotionColor = (emotion: string) => {
    switch (emotion) {
      ...
      case 'confusion': return 'bg-yellow-500';
        ...
        {!faceDetected && !analysisData ? (
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-400">Analyzing facial expressions</span>
              </div>
              <Progress value={45} className="h-2" />
            </div>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-400">Processing gestures</span>
              </div>
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                <span className="text-gray-400">Detected Emotions</span>
                <span className="text-gray-300">{(analysisData.emotions.confidence * 100).toFixed(0)}% confidence</span>
              </div>
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                <Badge variant="outline" className="px-3 py-1 border-gray-600">
